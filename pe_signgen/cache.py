...
class SignatureCache:
    ...
    def from_dict(cls, data: dict[str, Any]) -> SignatureCache:
        ...
        if "parameters" in data:
            ...
            from .constants import DEFAULT_MIN_SIGNATURE_LENGTH, DEFAULT_MAX_SIGNATURE_LENGTH
...
def load_cache(
    ...
    try:
        ...
        requested_params = CacheParameters(
...
def clear_cache(dll: str | None = None, func: str | None = None, arch: str | None = None) -> int:
    """
